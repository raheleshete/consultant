...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php esc_html_e( 'Product', 'consultantpro' ); ?></th>
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'consultantpro' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'consultantpro' ); ?></th>
			</tr>
		</thead>
		<tbody>
			...
			<ul class="wc_payment_methods payment_methods methods">
				<?php
					if ( ! empty( $available_gateways ) ) {
						...
						echo '<li>' . apply_filters( 'woocommerce_no_available_payment_methods_message', esc_html__( 'Sorry, it seems that there are no available payment methods for your location. Please contact us if you require assistance or wish to make alternate arrangements.', 'consultantpro' ) ) . '</li>';
					}
				?>
			</ul>
		<?php endif; ?>
