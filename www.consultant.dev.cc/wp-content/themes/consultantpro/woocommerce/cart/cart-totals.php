...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
	...
	<h2><?php esc_html_e( 'Cart Totals', 'consultantpro' ); ?></h2>

	<div class="shop_table shop_table_responsive">

		<ul>
			<li class="cart-subtotal">
				<?php esc_html_e( 'Subtotal', 'consultantpro' ); ?>
			...
			<?php elseif ( WC()->cart->needs_shipping() && 'yes' === get_option( 'woocommerce_enable_shipping_calc' ) ) : ?>
				...
				<li class="shipping">
					<?php esc_html_e( 'Shipping', 'consultantpro' ); ?>
					<span class="shipping-value" data-title="<?php esc_attr_e( 'Shipping', 'consultantpro' ); ?>"><?php woocommerce_shipping_calculator(); ?></span>
				</li>
			...
			<?php if ( wc_tax_enabled() && 'excl' === WC()->cart->tax_display_cart ) :
				...
				$estimated_text  = WC()->customer->is_customer_outside_base() && ! WC()->customer->has_calculated_shipping()
						? sprintf( ' <small>(' . esc_html__( 'estimated for %s', 'consultantpro' ) . ')</small>', WC()->countries->estimated_for_prefix( $taxable_address[0] ) . WC()->countries->countries[ $taxable_address[0] ] )
						: '';
			...
			<li class="order-total">
				...
				<span class="order-total" data-title="<?php esc_attr_e( 'Total', 'consultantpro' ); ?>"><?php wc_cart_totals_order_total_html(); ?></span>
			</li>
