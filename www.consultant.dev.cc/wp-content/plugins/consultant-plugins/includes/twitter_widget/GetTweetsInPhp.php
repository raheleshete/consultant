...
if (!class_exists('TwitterAPIExchange')) {
  require_once EF_ROOT .'/includes/twitter_widget/TwitterAPIExchange.php';
}

require_once EF_ROOT .'/includes/twitter_widget/TwitterTextFormatter.php';
 ...
 *   }
 */
if(!class_exists('GetTweetsInPhp')) {
    ...
    public static function get_tweets($configs) {
      ...
      $api_opts = self::get_only($configs, array(
        'screen_name', 
        'count', 
        'include_rts'
      ));
    ...
    private static function retrive_user_timeline(
      ...
      $settings = [
        'consumer_key' => $consumer_key,
        'consumer_secret' => $consumer_secret,
        'oauth_access_token' => '819124536419516417-y4rktz4mUktwRLk0Bnb5s758o0xXbJn',
        'oauth_access_token_secret' => 'T4Kp2kmr9QCSJToYWZLPLITNrzLmtjvPQSe3tD8boJYte'
      ];
